...
Plugin URI: http://www.mlcalc.com/widgets/mortgage-rates/
...
define('MLCALC_RATES_URL', get_option('siteurl') . '/wp-content/plugins/mlcalc_rates');
...
function display_mlcalc_rates($options = array()) {
	...
	if($form_size == 'small'){
		?>
		<script type="text/javascript">if(typeof jQuery == "undefined")document.write(unescape("%3Cscript src='" + (document.location.protocol == 'https:' ? 'https:' : 'http:') + "//ajax.googleapis.com/ajax/libs/jquery/1.3.2/jquery.min.js' type='text/javascript'%3E%3C/script%3E"));</script>
		 <!--[if lte IE 6]> <script type="text/javascript" src="http://www.mlcalc.com/themes/mlcalc/jquery.pngFix.js"></script> <![endif]--> <div id="MLCalcRatesForm<?php echo $SECTION["alias"]; ?>" class="MLCalcRatesForm"> <table cellpadding="0" cellspacing="0" width="150"> <tr> <td colspan="3" class="zeroHeight"><img src="http://www.mlcalc.com/themes/mlcalc/images/top-small.png" width="150" height="13" alt="" /></td> </tr> <tr> <td style="background: url(http://www.mlcalc.com/themes/mlcalc/images/left-bg.png)" width="7"></td> <td class="formPlaceHolder" width="136"> <form action="<?php echo $SECTION["url"]; ?>" method="post" id="MLCalcRatesFormTrend<?php echo $SECTION["alias"]; ?>" target="MLCalcRatesFrame"> <input type="hidden" name="state" value="<?php echo $SECTION["alias"]; ?>" /> <input type="hidden" name="wg" value="widget" /> </form> <table cellpadding="0" cellspacing="0" width="136"> <tr><td width="7"></td><td colspan="4"><?php if ($SECTION['alias'] == "XX") { echo '<div class="name">US Average<a href="' . $SECTION['url'] . '" class="nameB">Mortgage Rates</a></div>'; } else { echo '<a href="'. $SECTION['url'] . '" class="name">' . $SECTION['name'] . ' <b>Mortgage Rates</b></a>'; } ?></td></tr> <tr><td width="7" height="5"></td></tr> <tr class="odd" id="type30yf"> <td width="7"></td> <td width="83">30 Year Fixed</td> <td width="36"><span class="loading">loading...</span></td> <td width="5"></td> <td width="5"></td> </tr> <tr class="even" id="type15yf"> <td width="7"></td> <td width="83">15 Year Fixed</td> <td width="36"><span class="loading">loading...</span></td> <td width="5"></td> <td width="5"></td> </tr> <tr class="odd" id="type51arm"> <td width="7"></td> <td width="83">5/1 ARM</td> <td width="36"><span class="loading">loading...</span></td> <td width="5"></td> <td width="5"></td> </tr> <tr><td width="7" height="4" colspan="5"></td></tr> <tr><td colspan="5"> <center><table cellpadding="0" cellspacing="0"><tr> <td valign="bottom"><img src="http://www.mlcalc.com/themes/mlcalc/images/icon-trend-small.gif" width="15" height="12" alt="" /></td> <td width="5"></td> <td id="trendLink">View Trend</td> </tr></table></center> </td></tr> </table> </td> <td style="background: url(http://www.mlcalc.com/themes/mlcalc/images/right-bg.png)" width="7"></td> </tr> <tr> <td colspan="3" class="zeroHeight"><img src="http://www.mlcalc.com/themes/mlcalc/images/bottom-small.png" width="150" height="13" alt="" /></td> </tr> </table> </div> 
		<script type="text/javascript" src="<?php echo $SECTION['url']; ?>wordpress.js"></script>
		<?php

	} else {
		?>
		<script type="text/javascript">if(typeof jQuery == "undefined")document.write(unescape("%3Cscript src='" + (document.location.protocol == 'https:' ? 'https:' : 'http:') + "//ajax.googleapis.com/ajax/libs/jquery/1.3.2/jquery.min.js' type='text/javascript'%3E%3C/script%3E"));</script>
		 <!--[if lte IE 6]> <script type="text/javascript" src="http://www.mlcalc.com/themes/mlcalc/jquery.pngFix.js"></script> <![endif]--> <div id="MLCalcRatesForm<?php echo $SECTION["alias"]; ?>" class="MLCalcRatesForm"> <table cellpadding="0" cellspacing="0" width="300"> <tr> <td colspan="3" class="zeroHeight"><img src="http://www.mlcalc.com/themes/mlcalc/images/top.png" width="300" height="13" alt="" /></td> </tr> <tr> <td style="background: url(http://www.mlcalc.com/themes/mlcalc/images/left-bg.png)" width="7"></td> <td class="formPlaceHolder" width="286"> <form action="<?php echo $SECTION["url"]; ?>" method="post" id="MLCalcRatesFormTrend<?php echo $SECTION["alias"]; ?>" target="MLCalcRatesFrame"> <input type="hidden" name="state" value="<?php echo $SECTION["alias"]; ?>" /> <input type="hidden" name="wg" value="widget" /> </form> <table cellpadding="0" cellspacing="0" width="286"> <tr><td width="14"></td><td colspan="4" width="272"><?php if ($SECTION['alias'] == "XX") { echo '<div class="name">US Average<a href="' . $SECTION['url'] . '" class="nameB">Mortgage Rates</a></div>'; } else { echo '<a href="'. $SECTION['url'] . '" class="name">' . $SECTION['name'] . ' <b>Mortgage Rates</b></a>'; } ?></td></tr> <tr><td width="14" height="5"></td></tr> <tr class="odd" id="type30yf"> <td width="14"></td> <td width="157">30 Year Fixed</td> <td width="52"><span class="loading">loading...</span></td> <td width="35" class="change"></td> <td width="14"></td> </tr> <tr class="even" id="type15yf"> <td width="14"></td> <td width="157">15 Year Fixed</td> <td width="52"><span class="loading">loading...</span></td> <td width="35" class="change"></td> <td width="14"></td> </tr> <tr class="odd" id="type51arm"> <td width="14"></td> <td width="157">5/1 ARM</td> <td width="52"><span class="loading">loading...</span></td> <td width="35" class="change"></td> <td width="14"></td> </tr> <tr><td width="14" height="7" colspan="5"></td></tr> <tr><td colspan="6"> <center><table cellpadding="0" cellspacing="0"><tr> <td valign="bottom"><img src="http://www.mlcalc.com/themes/mlcalc/images/icon-trend.gif" width="18" height="15" alt="" /></td> <td width="6"></td> <td id="trendLink">View Trend</td> </tr></table></center> </td></tr> <tr><td width="14" height="3" colspan="5"></td></tr> </table> </td> <td style="background: url(http://www.mlcalc.com/themes/mlcalc/images/right-bg.png)" width="7"></td> </tr> <tr> <td colspan="3" class="zeroHeight"><img src="http://www.mlcalc.com/themes/mlcalc/images/bottom.png" width="300" height="13" alt="" /></td> </tr> </table> </div> 
		<script type="text/javascript" src="<?php echo $SECTION['url']; ?>wordpress.js"></script>
		<?php
	}
...
function mlcalc_rates_head_data(){
	...
	$form_size = empty( $options['form_size'] ) ? 'small' : $options['form_size'];
	if($form_size == 'small'){
		echo '<link type="text/css" rel="stylesheet" href="http://www.mlcalc.com/themes/mlcalc/rates-widget-form-small.css" />';
	} else {
		echo '<link type="text/css" rel="stylesheet" href="http://www.mlcalc.com/themes/mlcalc/rates-widget-form.css" />';
	}
}
